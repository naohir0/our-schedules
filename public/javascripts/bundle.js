...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.availbutton').each(function (i, e) {
  ...
  button.click(function () {
    ...
    var avail = button.data('avail');
    var nextAvail = (avail + 1) % 3;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.comment-button').each(function (i, e) {
  ...
  button.click(function () {
    ...
    var newcomment = window.prompt('コメントを入力してください');

    if (newcomment) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/schedules/".concat(scheduleId, "/users/").concat(userId, "/comment"), {
        newcomment: newcomment
      }, function (data) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.comment-text').text(data.comment);
      });
    }
  });
});
